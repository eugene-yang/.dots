...
try:
    import conda
    conda_v = "Conda " + conda.__version__
except:
    conda_v = ""
...
"3d": r"""
 ____
/\  _`\\
\ \ \L\_\  __  __     __      __    ___      __
 \ \  _\L /\ \/\ \  /'_ `\  /'__`\/' _ `\  /'__`\
  \ \ \L\ \ \ \_\ \/\ \L\ \/\  __//\ \/\ \/\  __/
   \ \____/\ \____/\ \____ \ \____\ \_\ \_\ \____\
    \/___/  \/___/  \/___L\ \/____/\/_/\/_/\/____/
                      /\____/
                      \_/__/
""",
...
c.InteractiveShell.banner1 = """Python {python_version} | {conda_version} {banner_art}
You are on machine [{machine}] under env [{env}], happy working :))
""".format(
    banner_art = banner_art['blocks'],
